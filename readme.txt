...
A very light-weight plugin, designed to make updating meta-values (title, caption, description and alternate text) more efficient, by providing one central table of imagery and a duplicate button to copy this information across fields.


**Simple, Straight-Forward Meta Updates**

All current imagery is presented in a table, sortable by TITLE or DATE.
...
1. Access ImageMeta in the Admin > Tools flyout, and away you go!
